    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poly_line', django.contrib.gis.db.models.fields.GeometryField(srid=900913)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transit_step', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transit_details', to='routes.step')),
            ],
            options={
                'abstract': False,
            },
